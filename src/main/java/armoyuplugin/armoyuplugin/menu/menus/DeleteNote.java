package armoyuplugin.armoyuplugin.menu.menus;
...
public class DeleteNote extends Menu {
    ...
    public void handleMenu(InventoryClickEvent e) throws MenuManagerNotSetupException, MenuManagerException {
        ...
        if (e.getCurrentItem().getType() == Material.BARRIER){
            ...
            Note note = NoteStorageUtility.findNote(container.get(new NamespacedKey(ARMOYUPlugin.getPlugin(), "noteid"), PersistentDataType.STRING));
    ...
    public void setMenuItems() {
        ...
        for (int i = 0; i < findAllNotes.size(); i++) {
            ...
            itemMeta.getPersistentDataContainer().set(new NamespacedKey(ARMOYUPlugin.getPlugin(), "noteid"), PersistentDataType.STRING, note.getId());
